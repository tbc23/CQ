...
/* package quipper-all-0.9.0.0 */
#ifndef VERSION_quipper_all
#define VERSION_quipper_all "0.9.0.0"
#endif /* VERSION_quipper_all */
#ifndef MIN_VERSION_quipper_all
#define MIN_VERSION_quipper_all(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  9 || \
  (major1) == 0 && (major2) == 9 && (minor) <= 0)
#endif /* MIN_VERSION_quipper_all */
